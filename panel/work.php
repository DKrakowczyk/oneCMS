...
?>
    <div class="content-wrapper">
        ...
        <li class="breadcrumb-item" style="text-align:center !important;margin:auto;">
          <a href="cpanel.php" >Edycja sekcji "Work"</a>
        </li>
    </ol>
...
<form method="POST">
  <div class="form-group">
    ...
    <input type="text" name ="header" class="form-control" id="header" value="<?php $one->current_header($db,'header'); ?>"/>
  </div>
  <div class="form-group">
    <label for="header_small">Section header 2 <code>&lth3&gt</code></label>
    <input type="text" name ="header_small" class="form-control" id="header_small" value="<?php $one->current_header($db,'header_small'); ?>">
  </div>
...
<form method="POST">
  <div class="form-group">
    <label for="names">Company <code>&lth5&gt</code> </label>
    <input type="text" name ="names" class="form-control" id="names" value="">
  </div>
  <div class="form-group">
    <label for="roles">Role<code>&lth5&gt</code> </label>
